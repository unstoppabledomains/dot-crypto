...
describe('DotCrypto', () => {
  ...
  //       const input = 0x1234
  //       const bytes = await dotCrypto.methods.uint256ToBytes(input).call()
  //       // const ui = await dotCrypto.methods.bytesToUint256(bytes).call()

  //       console.log('input', '0x' + input.toString(16))
  //       // console.log('ui', '0x' + ui.toString(16))
  //       console.log('bytes', '0x' + bytes.toString(16))
  //     })
    ...
    contract('tokenURI(uint256)', ([coinbase, address2, ...addresses]) => {
      it('should get tokenUri', async () => {
        ...
        const tokenUri = await dotCrypto.methods
          ...
          .call()
        expect(tokenUri).to.equal('dcrypto:crypto.')
      })
