...
solc --abi --bin -o abi --allow-paths ${dir:-.} --optimize --optimize-runs 200 @openzeppelin=${INIT_CWD:-.}/node_modules/@openzeppelin @chainlink=${INIT_CWD:-.}/node_modules/@chainlink contracts/*.sol contracts/**/*.sol >/dev/null
